...
var (
	opsProcessed = promauto.NewCounter(prometheus.CounterOpts{
		Name: "myapp_processed_nats_event_total",
		Help: "The total number of processed nats events",
	})
)

func (svc *NatsReqReplyService) InitEventHandlers() {
	svc.eventEmitter.On("nats.request.income", func(ctx context.Context, payload interface{}) {
