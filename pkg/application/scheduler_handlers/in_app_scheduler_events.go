...
var (
	opsProcessed = promauto.NewCounter(prometheus.CounterOpts{
		Name: "myapp_processed_in_app_jobs_total",
		Help: "The total number of processed in app jobs",
	})
)

func (svc *InAppScheduledJobService) InitEventHandlers() {
	svc.eventEmitter.On("job.hello", func(ctx context.Context, payload interface{}) {
		fmt.Printf("JOB_STARTED")
		opsProcessed.Inc()
	})
