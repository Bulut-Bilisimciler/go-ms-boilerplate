...
var (
	opsProcessed = promauto.NewCounter(prometheus.CounterOpts{
		Name: "myapp_processed_http_event_total",
		Help: "The total number of processed http request",
	})
)

func (svc *HTTPHandlerService) InitEventHandlers() {
	svc.eventEmitter.On("http.request.income", func(ctx context.Context, payload interface{}) {
